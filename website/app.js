...
const translations = {
  de: {
    ...
    metricExplanation:
      "93 % messen die bisherige Alpha-Grundlage. Der neue Medien- und Mehrgeräte-Kern ist verbindlich geplant, aber noch nicht implementiert und wird deshalb getrennt mit 0 % ausgewiesen.",
    languages: "Sprachen",
  ...
  en: {
    ...
    metricExplanation:
      "93% measures the existing alpha foundation. The new media and multi-device core is committed to the plan but not implemented yet, so it is shown separately at 0%.",
    languages: "languages",
